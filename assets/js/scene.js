...
rpGame.Scene = new Phaser.Class({
    ...
    rp: {
        imageUrl: rpApp.assetsPath,
        audioUrl: rpApp.assetsPath,
        tile: 100,
        frameRate: 10,
        width: 1600,
        height: 900,
        font: {
            ...
            serif: 'adelle,serif',
            x: 0.5 * 1600,
            y: !document.documentElement.classList.contains('touchevents') ? 900 - (1.75 * 100) : 3 * 100,
            styles: {
        ...
        utils: {
            ...
            destroyGame: function(scene) {
                ...
                document.getElementById('rpGame').classList.remove('active');
                document.getElementById('rpGame').innerHTML = '';
                document.getElementById('rpGameModal').classList.remove('active');
